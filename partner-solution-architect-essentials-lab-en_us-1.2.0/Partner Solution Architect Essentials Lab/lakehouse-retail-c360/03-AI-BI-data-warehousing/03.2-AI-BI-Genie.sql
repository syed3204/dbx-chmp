...
-- MAGIC
-- MAGIC Let's see how this can be done with [Databricks Machine Learning notebook]($../04-Data-Science-ML/04.1-churn-prediction) | go [Go back to the introduction]($../00-churn-introduction-lakehouse)
