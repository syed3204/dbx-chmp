...

{
  ...
  "notebooks": [
    ...
    {
      "path": "04-Data-Science-ML/04.1-churn-prediction", 
      "pre_run": True, 
      "publish_on_website": True, 
      "add_cluster_setup_cell": True,
    ...
    {
      "path": "04-Data-Science-ML/04.2-model-evaluation",
      "pre_run": True, 
      "publish_on_website": True, 
      "add_cluster_setup_cell": True,
    ...
    "settings": {
        ...
        "tasks": [
            ...
            },
            {
                ...
                "notebook_task": {
                    "notebook_path": "{{DEMO_FOLDER}}/04-Data-Science-ML/04.1-churn-prediction",
                    "source": "WORKSPACE"
                },
                "job_cluster_key": "Shared_job_cluster",
                "timeout_seconds": 0,
            ...
            },
            {
                ...
                "notebook_task": {
                    "notebook_path": "{{DEMO_FOLDER}}/04-Data-Science-ML/04.2-model-evaluation",
                    "source": "WORKSPACE"
                },
