...
-- MAGIC
-- MAGIC 4. **Predictive Intelligence**: `Marc` trains custom machine learning models that predict which customers are likely to churn and identify the key factors contributing to churn risk. These models continuously improve as new data becomes available.
-- MAGIC
-- MAGIC 5. **AI-Powered Intervention**: `Liza` leverages Databricks AI to transform predictive insights into preventative actions. Using generative AI, she creates personalized retention campaigns, tailored offers, and proactive customer service interventions that address specific churn risk factors.
-- MAGIC
...
-- MAGIC %md-sandbox
-- MAGIC ## 4/ Predict churn with Data Science & ML
-- MAGIC
...
-- MAGIC
-- MAGIC This is where the Intelligence Data Platform value comes in. Within the same platform, anyone can start building ML model to run such analysis, using MLflow for experiment tracking and model management.
...
-- MAGIC
-- MAGIC This is where Liza, our Gen AI Engineer, leverages Databricks Databricks AI to transform predictive insights into targeted interventions that drive measurable retention improvements.
-- MAGIC
