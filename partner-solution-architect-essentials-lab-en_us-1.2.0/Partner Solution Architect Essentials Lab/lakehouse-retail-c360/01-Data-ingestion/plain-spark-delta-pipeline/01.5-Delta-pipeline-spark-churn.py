...
# MAGIC
# MAGIC *Note that we're including the ML model our [Data Scientist built](TODO) using ML to predict the churn.*
...
# MAGIC %sql
# MAGIC LIST '/Volumes/dbacademy/${schema}/c360/users'

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM json.`/Volumes/dbacademy/${schema}/c360/users`
